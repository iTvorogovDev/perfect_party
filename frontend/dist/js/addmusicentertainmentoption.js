...
function onRegisterAttempt(event) {
    ...
    const item = {
        ...
        itemType: "MusicEntertainmentOption",
        itemName: nameField.value,
        itemDescription: descriptionField.value,
        price: priceField.value,
        availableStartDateTime: startdatetimeField.value,
        availableEndDateTime: enddatetimeField.value,
    }
...
function registerCustomer(event) {
    ...
    postAjax("http://localhost:8080/addMusicEntertainmentOption", event, (xmlhttp) => {
        // if (xmlhttp.responseText == "[]") {
            window.location.replace('./employeehome.html')
        // }
    })
