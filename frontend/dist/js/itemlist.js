const venueDisplayTable = document.getElementById("item-table")

getVenueListing()

function getVenueListing() {
    console.log("Attempting to get item list", event)
    postAjax("http://localhost:8080/getItemTable", null, (xmlhttp) => {
